...
while ($true) {
cls
write-output "Add User to Power Users Group"
...
$PowerGroup = "Power Users"
$Domain = "corp.supersol.co.il"
$DomainCredential = Get-Credential "supersol\***adm"
([ADSI]"WinNT://$Computer/$PowerGroup,group").psbase.Invoke("Add",([ADSI]"WinNT://$Domain/$UserName").path)
write-host "`n" # for creating space

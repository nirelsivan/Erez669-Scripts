...
powershell.exe -Command "Start-Process 'powershell' -Verb RunAs -ArgumentList '/c "powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0CopyFiles_MultipleServers.ps1"'"
